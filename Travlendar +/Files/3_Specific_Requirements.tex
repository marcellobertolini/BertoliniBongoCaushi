...
\begin{enumerate}
	...
	\item \textbf{User Profile}\\
			\vspace{0cm}\\
			The user will have a personal page in which he can customize his preferences to fit the application to his needs. He will be able to add tags (see “tag creation”), to edit the lunch section, to select the means of transport he would like the system to use in its computations and he will also be able to insert his personal season ticket in the homonym field. 
			The system will warn the user with a notification when it’ll be next to the expiry date. 
			\begin{figure}[H]
				\centering
	...
	\item \textbf{Event Creation and Trip Planning}\\
			...
			Otherwise, if it is not located in the user’s location, the system will suggest the creation of a trip helping the user to book the tickets to reach the desired town.
			\begin{figure}[H]
				\centering
	...
	\item \textbf{Tag Settings}\\
			\vspace{0cm}\\
			In this section the user will be able to create a tag that contains a list of the means of transport that can be enabled. It’ll be present another field called “anticipation time” that will be used by the system during the computation of the routes.
			\begin{figure}[H]
				\centering
	...
	\item \textbf{Event View}\\
			\vspace{0cm}\\
			The user will be able to review his appointments in the calendar section. An arrow will connect each meeting, colored of yellow in presence of bad weather and strikes, and otherwise it’ll be blue.
			\begin{figure}[H]
				\centering
...
\vspace{0.5cm}\par
The system has to ask the users' permission to retrieve and use their positions. Telephone numbers and email addresses won't be used for commercial purposes but just for identify and support them when needed.
\vspace{0.5cm}\\
...
\vspace{0.2cm}
The system has to be able to respond to a great number of simultaneously users’ requests in order give the best route in the shortest time possible. In order to obtain the best performances, the computation will be provided by an external service.
\vspace{0.5cm}\\
...
\vspace{0.2cm}\par
Due to the continuous enlargement of the sharing companies and new ways to travel, the system has to guarantee a high level of scalability to be maintained updated.
\vspace{0.5cm}\\
\indent \textbf{Security}
\vspace{0.2cm}\par
The data must be encrypted based on the user’s password and a personal security key provided to the user during the account creation. In this way the information will be always available to the user and hided by the ones who don’t have the required permissions.
\vspace{0.5cm}\\
\indent \textbf{Accuracy}
\vspace{0.2cm}\par
The accuracy of the information provided, such as the sharing positions and the route provided by the system must be as best as possible.